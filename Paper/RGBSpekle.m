...
for channel = 1:3
    ...
    % Calculate Speckle noise with desired variance
    variance = 0.01;  % Adjust this value
    noise_image_channel = imnoise(zeros(size(original_image_double_channel)), 'speckle', variance);
...
% Display results
fprintf('==========================\n');
fprintf('Speckle Noise Parameters:\n');
fprintf('Variance: %f\n', variance);
fprintf('==========================\n');
...
title('Watermarked Image with Speckle Noise');
subplot(1, 4, 4);
